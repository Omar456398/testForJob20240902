...
const [bagState, setBagState] = useState([{id: 'huarache-x-stussy-le', selectedAttributes: {Size: '40' }, count: 2}, {id: 'jacket-canada-goosee', selectedAttributes: {Size: 'Medium' } , count: 1}, {id: 'ps-5', selectedAttributes: {Color: 'Green', Capacity: '512G'}, count: 1}])

  return (
    <Context.Provider value={{ prodState, setProdState, bagState, setBagState }}>
      {children}
    </Context.Provider>
  );
};
