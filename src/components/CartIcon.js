  ...
  return (
    <div className="relative">
      ...
      >
        {itemCount ? (
          <span
            className="absolute inline-flex items-center justify-center px-1 py-1 h-5 text-xs font-bold leading-none text-white bg-black rounded-full"
            style={{ top: -10, left: 10, aspectRatio: 1 }}
          >
            {itemCount}
          </span>
        ) : null}
